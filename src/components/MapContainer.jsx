...
mapboxgl.accessToken = "pk.eyJ1IjoicGFpZ2V3aWxsaWFtcyIsImEiOiJjanNzNDlkc2QxcDg4NDRvMnllMTY5d3FhIn0.fdKpE8Pe2MuB4oe05YCvLw";
...
class Map extends React.Component {
  ...
  render() {
    return (
      <div>
        <MapContainerStyle ref={el => this.mapContainer = el} />
      </div>
    );
  }
}
